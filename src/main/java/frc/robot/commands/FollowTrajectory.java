...
public class FollowTrajectory extends CommandBase {
  ...
  public FollowTrajectory(DrivetrainSubsystem m_Subsystem, PathContainer pathContainer) {
    ...
    rotPID = Constants.auto.follower.ROT_PID_CONTROLLER;
  ...
  public void initialize() {
    ...
    hController = new HolonomicDriveController(Constants.auto.follower.X_PID_CONTROLLER, Constants.auto.follower.Y_PID_CONTROLLER, rotPID);
